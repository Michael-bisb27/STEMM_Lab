            ...
            <SafeAreaView style={styles.safeArea} edges={['left', 'right', 'bottom']}>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.mainScroll}>
                    ...
                    <TouchableOpacity onPress={toggleCurriculum} style={[styles.curriculumBtn, showCurriculum && styles.curriculumExpanded]}>
                        ...
                        {showCurriculum && (
                            <View style={styles.curriculumInfo}>
                                <Text style={styles.currSubject}>Science / Health and Wellbeing</Text>
                                <Text style={styles.currCode}>• ACSSU073 – Sound and energy</Text>
                                <Text style={styles.currCode}>• ACPPS053 – Health and wellbeing</Text>
                            </View>
                        )}
                    </TouchableOpacity>
                    ...
                    <View style={styles.overviewBox}>
                        <Image source={require('../assets/images/sound_snippet.png')} style={styles.soundIcon} />
                        <View style={styles.overviewTextContainer}>
                            <Text style={styles.overviewText}>
                                <Text style={styles.bold}>Overview: </Text>
                                {activity?.activityDescription || "Investigate the level of environmental sound pollution around your current location."}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.notebookContainer}>
                        ...
                        <View style={styles.bulletList}>
                            <Text style={styles.bulletPoint}>• Predict which action created the loudest sound</Text>
                            ...
                            <Text style={styles.bulletPoint}>
                                • Should we wear <Text style={styles.underlined}>ear muffs</Text> in your classroom?
                            </Text>
                        </View>
                        ...
                        <View style={styles.tableWrapper}>
                            <View style={styles.tableRow}>
                                ...
                                <View style={[styles.tableCell, styles.headerCell, { flex: 1.1 }]}>
                                    <Text style={styles.tableHeaderText}>Prediction (louder or softer than)</Text>
                                </View>
                                <View style={[styles.tableCell, styles.headerCell, { flex: 0.9 }]}>
                                    <Text style={styles.tableHeaderText}>Outcome (dB)</Text>
                                </View>
                                <View style={[styles.tableCell, styles.headerCell, { flex: 0.9 }]}>
                            ...
                            <View style={styles.tableRow}>
                                <View style={[styles.tableCell, { flex: 1.2 }]}>
                                    <Text style={styles.rowLabel}>Action 1 (e.g. dropping a book on the table)</Text>
                                </View>
                    ...
                    <TouchableOpacity 
                        ...
                        onPress={() => router.push('/sound_ready')}
                    >
...
const styles = StyleSheet.create({
    ...
    soundIcon: { width: 60, height: 60, marginRight: 15, resizeMode: 'contain' },
    ...
    bulletPoint: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 15, color: '#333', marginBottom: 6 },
    underlined: { textDecorationLine: 'underline' },
    tableWrapper: { borderWidth: 1, borderColor: '#000', borderRadius: 4, overflow: 'hidden' },
    tableRow: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#000', minHeight: 55 },
    ...
    rowLabel: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 12, color: '#000' },
