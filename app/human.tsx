                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.mainScroll}>
                    ...
                    <View style={styles.titleSection}>
                        ...
                        <Text style={[styles.activityName, { color: currentTheme.textColor }]}>
                            {activity?.activityName || "Human Performance Lab – Stretch Speed & Gracefulness"}
                        </Text>
                    </View>
                    ...
                    <TouchableOpacity onPress={toggleCurriculum} style={[styles.curriculumBtn, showCurriculum && styles.curriculumExpanded]}>
                        ...
                        {showCurriculum && (
                            <View style={styles.curriculumInfo}>
                                <Text style={styles.currSubject}>Health & Physical Education</Text>
                                <Text style={styles.currCode}>ACPPS051 – Movement skills</Text>
                                <Text style={styles.currCode}>ACPPS054 – Physical performance</Text>
                                
                                <Text style={[styles.currSubject, { marginTop: 10 }]}>Science (Biology)</Text>
                                <Text style={styles.currCode}>ACSSU176 – Structure and function of body systems</Text>
                            </View>
                        )}
                    </TouchableOpacity>
                    ...
                    <View style={styles.overviewBox}>
                        ...
                        <View style={styles.overviewTextContainer}>
                            <Text style={styles.overviewText}>
                                ...
                                {activity?.activityDescription || "Analyze stability, extension, and control using your device tracking telemetry."}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.notebookContainer}>
                        ...
                        <View style={styles.bulletList}>
                            <Text style={styles.bulletPoint}>• Which movement was the hardest to keep the vibration low?</Text>
                        ...
                        <View style={styles.tableWrapper}>
                            <View style={styles.tableRow}>
                                ...
                                <View style={[styles.tableCell, styles.headerCell]}>
                                    <Text style={styles.tableHeaderText}>Predict Phone Vibration Sensor (absolute)</Text>
                                </View>
                                <View style={[styles.tableCell, styles.headerCell]}>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={styles.tableCell}>
                                    <Text style={styles.outcomeText}>5 mm in 20 seconds</Text>
                                </View>
                                <View style={styles.tableCell} />
                            </View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={styles.tableCell} />
                                <View style={styles.tableCell}>
                                    <Text style={styles.outcomeText}>5 mm in 5 seconds</Text>
                                </View>
                                <View style={styles.tableCell} />
                            </View>
                    ...
                    <TouchableOpacity 
                        ...
                        onPress={() => router.push('/human_ready')}
                    >
...
const styles = StyleSheet.create({
    ...
    currCode: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 12, color: '#666', marginBottom: 2 },
    ...
    bulletPoint: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 14, color: '#333', marginBottom: 6, lineHeight: 18 },
    ...
    tableHeaderText: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 9, textAlign: 'center', color: '#000', fontWeight: '500' },
    rowLabel: { fontFamily: 'BalsamiqSans_700Bold', fontSize: 12, textAlign: 'center' },
    exampleText: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 11, color: '#888', fontStyle: 'italic', textAlign: 'center' },
    outcomeText: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 11, color: '#333', textAlign: 'center' },
