                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.mainScroll}>
                    ...
                    <TouchableOpacity onPress={toggleCurriculum} style={[styles.curriculumBtn, showCurriculum && styles.curriculumExpanded]}>
                        ...
                        {showCurriculum && (
                            <View style={styles.curriculumInfo}>
                                <Text style={styles.currSubject}>Health, Physical Education & Science</Text>
                                <Text style={styles.currCode}>• ACSSU176 – Body systems</Text>
                                <Text style={styles.currCode}>• ACPPS054 – Physical activity and health</Text>
                            </View>
                        )}
                    </TouchableOpacity>
                    ...
                    <View style={styles.overviewBox}>
                        ...
                        <View style={styles.overviewTextContainer}>
                            <Text style={styles.overviewText}>
                                ...
                                {activity?.activityDescription || "Track and analyze your breathing rhythm patterns at rest and after physical activity bursts."}
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.notebookContainer}>
                        ...
                        <View style={styles.bulletList}>
                            <Text style={[styles.bulletPoint, styles.italicText]}>• Predict which fold design makes the phone move the least.</Text>
                        ...
                        <View style={styles.tableWrapper}>
                            <View style={styles.tableRow}>
                                ...
                                <View style={[styles.tableCell, styles.headerCell, { flex: 1.2 }]}>
                                    <Text style={styles.tableHeaderText}>Predict Breathe per minute</Text>
                                </View>
                            ...
                            <View style={styles.tableRow}>
                                ...
                                <View style={[styles.tableCell, { flex: 1.2 }]}>
                                    <Text style={styles.exampleText}>e.g. 6 breath per minute</Text>
                                </View>
...
const styles = StyleSheet.create({
    ...
    currCode: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 12, color: '#555', marginBottom: 2 },
    ...
    breathingIcon: { width: 60, height: 60, marginRight: 15, resizeMode: 'contain' },
    ...
    rowLabel: { fontFamily: 'BalsamiqSans_700Bold', fontSize: 11 },
    exampleText: { fontFamily: 'BalsamiqSans_400Regular', fontSize: 10, color: '#888', fontStyle: 'italic', textAlign: 'center' },
